...
```text
Intent:
Modernize agent governance without making apt-principles an implementation repo.
...
- Adding implementation responsibilities to `apt-principles` that belong to APT Agent or `apt-agent-standards`.
