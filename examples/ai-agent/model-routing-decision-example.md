...
APT Agent can map capability tiers to concrete tools in local configuration. `apt-principles` should keep only the routing standard, decision shape, and evidence expectations.
