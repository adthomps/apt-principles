...
- A target repo may adopt managed standards from `apt-agent-standards`.

## Avoid When

- The task is installer behavior, path mapping, or profile detection that belongs in `apt-agent-standards`.
